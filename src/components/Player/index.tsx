...
export function Player() {
    ...
    const { episodeList, currentEpisodeIndex,
        ...
        isLooping, toggleLoop, toggleShuffle, isShuffling,
        clearPlayerState} = useContext(PlayerContext)
    ...
    return (
        <div className={styles.playerContainer}>
            ...
            <footer className={episode ? styles.empty : ""}>
                ...
                {episode && (
                    <audio
                        src={episode.url} autoPlay
                        onEnded={handleEpisodeEnded}
                        ref={audioRef} onPlay={() => setPlayingState(true)}
                        onPause={() => setPlayingState(false)}
                        loop={isLooping} onLoadedMetadata={setupProgressListener}
                    />
